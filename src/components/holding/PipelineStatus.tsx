        ...
        <div className="flex flex-col gap-3">
          ...
          {status?.json_url ? (
            <a
              ...
              className="inline-flex items-center justify-center h-11 rounded-lg border border-navy-600 text-white font-semibold hover:bg-navy-800 transition"
            >
              {isEs ? "Descargar JSON" : "Download JSON"}
            </a>
          ) : null}
